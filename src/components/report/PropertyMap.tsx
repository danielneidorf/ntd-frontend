...
function loadGoogleMaps(callback: () => void) {
  ...
  // Check if script is already being loaded (e.g. by QuickScanFlow)
...
async function fetchBuildingContour(
  ...
  try {
    ...
    // Find the building closest to the property
...
export default function PropertyMap({
  ...
  useEffect(() => {
    ...
    loadGoogleMaps(() => {
      ...
      // Optional: building contour overlay
  ...
  return (
    <div
      ref={mapRef}
      className="w-full h-[280px] sm:h-[280px] rounded-lg overflow-hidden mb-5"
